...
import 'package:dailyneedsserver/screens/homeScreen/homeScree.dart';
...
import 'package:dailyneedsserver/restartApp.dart';
    ...
    _auth.verifyPhoneNumber(
      ...
      verificationCompleted: (AuthCredential credential) async {
        ...
        if (user != null) {
          ...
          _showSpinner = false;
          String token = await FireBaseMessagingClass().getFirebaseToken();
          await FirebaseFirestore.instance
              .collection('admin/admin/deliveryBoys')
              .doc(user.uid)
              .update({'token': token});
                                        ...
                                        try {
                                          ...
                                          if (user != null) {
                                            DocumentSnapshot snap =
                                                await FirebaseFirestore.instance
                                                    .collection(
                                                        'admin/admin/deliveryBoys')
                                                    .doc(user.uid)
                                                    .get();
                                            if (snap.exists) {
                                              String token =
                                                  await FireBaseMessagingClass()
                                                      .getFirebaseToken();
                                              await FirebaseFirestore.instance
                                                  .collection(
                                                      'admin/admin/deliveryBoys')
